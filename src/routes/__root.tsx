...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "My Second Brain" },
      ...
      { name: "twitter:title", content: "My Second Brain" },
      { name: "twitter:description", content: "Explore your knowledge graph as a dark constellation of notes, code, blogs, and art." },
